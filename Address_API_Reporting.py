...
filtered_df = result_df.filter((result_df.delivery_issues == "address_issue") | (result_df.delivery_issues == "other_issue") & (result_df.carrier_account_type == 'shippo_master'))
